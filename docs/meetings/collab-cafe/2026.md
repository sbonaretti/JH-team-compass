...
* Ely / @ohrely / Bloomberg / MA
* Ryan / @rylo / UC Berkeley / California
* Jenny (she/her) / 2i2c / @jnywong / Yorkshirrrrrre, UK
* Kirstie (she/her) / UC Berkeley / California 
...
* Chris Holdgraf / @choldgraf / 2i2c/ Oooooakland
* Stéfan van der Walt / @stefanv / UC Berkeley

### Ice breaker 🧊⛏️
What open-source project do you admire (beyond Jupyter!) and what can we learn from it?

* django - great documentation and community support efforts
* I like what R Ladies+ do for the R community <3
* I have recently developed my appreciation for seaborn and their documentation :D (just for a change from Turing Way 💖)
* Kirstie: I really love the Scientific Python community's SPECs - figuring out some practices and getting a bunch of libraries to endorse them
  * https://scientific-python.org/specs
* Mike: tidyverse/posit especially since they started sponsoring plotnine :)
* kubernetes (?) - it seems very well structured as an outsider
* Golang and Ruby
* Zig: 
...
* New blog posts:
  * JupyterHub 6.0: https://medium.com/jupyter-blog/jupyterhub-6-0-df28f06ea3ed 
  * Understanding the documentation of Jupyter Book and MyST (Serena's monthly report): https://jupyterbook.org/blog/posts/2026/cm-jb-myst-docs
* Jupyter Open Studio Day London
  * Friday October 2 (before Prague summit)
  * Register at https://go.bloomberg.com/attend/invite/jupyter-open-studio-day-in-london-october-2-2026/
* Jupyter Day!! Please join us
  * jupyterfoundation.org/event/jupyter-day-2026/
  * Kirstie co-chairing the program committee so if you missed the CFP deadline but would like to present then please let me know (we got 25 submissions, so we have a lot but not TOO many!)
* I've also spotted Paris Compute! that may be interesting to EU folks
  * https://compute.events/paris2026/schedule.html
  * Serena: I will be there! Let me know if you will join!
  * nice! it's cool they have a specific Jupyter track
* Angus for helping to get the JupyterBook CfP done: 
  * https://github.com/jupyter-governance/funding-proposals/issues/91
* Coming up: Jupyter Mini Summit at Open Source Summit Europe, 6 October 2026  https://events.linuxfoundation.org/open-source-summit-europe/features/co-located-events/#jupyter-mini-summit

### Breakout room and agenda item suggestions

* **Reminder**: Please, do not forget to **take notes during the breakout sessions**, so that we can archive them! Thanks! 😊

* JupyterHub: 2nd HubDash: 30 November and 1 December 2026: https://github.com/jupyterhub/team-compass/issues/926
  * Discuss timeline proposed in the issue
  * Identify 2-3 potential responders/reviewers who can send us a feedback between Oct 6 and 19
  * Refine questionnaire draft: https://docs.google.com/forms/d/1NSpxntszgg2k_ulg5-urX2XA4LgdfdJKA9EHEjKUCEY
    * First feedback: too long! :) --> Let's focus on the questions that make us reach our goals! (Goals are listed in the Issue and at the top of the Survey)
* JupyterBook / MyST
* Post main collab café discussion
  * Make JH an IdP with OIDC!
  * Helps with sharing tokens that are managed by JH and not an external auth provider
  * Especially pertinent when more folks want to privately share tokens to talk to LLMs (amongst other things!) so that we don't have to inject into the user environment
  * https://github.com/jupyterhub/roadmap/issues/13

#### Notes for Main room: MyST / JupyterBook

* JupyterLab-MyST:
  * Proposal "Jupyter and Markdown": https://github.com/jupyter-governance/funding-proposals/issues/83
    * https://docs.google.com/document/d/1ft5tZkABGtw7sDUxJGDhGP20cML6PulNG0ZfbNF2PC4/edit?tab=t.0
  * In the meantime, mike: Would like to work on https://github.com/jupyter-book/jupyterlab-myst/pull/301
  * This is blocked on updating to use the jupyter-builder, Angus is on it
* JupyterLab-MyST is limited w/r/t Jupyter Book
  * Because Jupyter Book is a parser+renderer but also a document engine.
* Does the current proposal (#83 above) deliver on a foundation for building a MyST renderer / editor?
  * inspiration: https://github.com/antmicro/myst-editor
  * Existing resource: https://prosemirror.net/
  * Ideas have come from the MyST workshop in Paris: https://medium.com/know-thyself-heal-thyself/like-stumbling-through-fog-e8c455697257
* How does this work intersect with PlainB?
  * https://github.com/notebook-link/jupyter-plainb
  * We need to better communicate across projects about 
* Note that there's another proposal around localization:  https://docs.google.com/document/d/1ft5tZkABGtw7sDUxJGDhGP20cML6PulNG0ZfbNF2PC4/edit?tab=t.0
  * Are there ways for them to engage with Jupyter Book?

#### Notes for Breakout room 1: JupyterHub

* We are looking at  https://github.com/jupyterhub/team-compass/issues/926
* discussion on timeline
* already have some initial feedback on the questionnaire -- the main takeaway is that it's currently too long, but that's okay since it was a very early draft
* List of 3 early testers for feedback
  * Shane Knapp
  * jenny (happy to stand aside for an "outsider")
  * Kelly (saw the questionnaire last time)
* Feedback on this version of the form
  * One thing that's missing from the first instance of this form last year is a space for the respondent to share things they're proud of about the deployment - we ask about lessons learnt, but not explicitly what's gone right
  * If we're asking about JH deployments, then the section on community feels disjointed and extends the survey
  * I suggest we offer (if we can) the option to have a chat instead nad have a volunteer fill out the form with the deployers 
* Suggestions from Ryan
  * Uncapitalize section headers (shouting)
  * Section 3: HPC infra can be institutional, public cloud, private, etc.
  * Section 3: Combine JupyterHub access to GPUs yes/no with explanation
  * Section 5: Elaborate on documentation? JupyterHub specific or just platform docs
* Feedback from Jenny:
  * I think we can omit the 'what packages do you provide' question -- that is huge and difficult to answer
  * Sections 3 + 4 + 6 could be merged and condensed
* We started curating and consolidating the form together based on the feedback above
  * Discussed a lot of details but made progress
...
* Ryan Lovett (he/him) / @ryanlovett / UC Berkeley / California
* April Johnson (she/they) / @aprilmj / 2i2c / Virginia
* Serena Bonaretti / @sbonaretti / Switzerland
* Kelly Rowland / @kellyrowland / NERSC/ Calif.
* Harold Campbell / @haroldcampbell / 2i2c / Jamaica
* Jenny Wong (she/her) / @jnywong /2i2c/ Yorkshirrrrrre
* Stéfan van der Walt / @stefanv
* Angus Hollands (he/him) / @agoose77 / 2i2c / Rugby, UK
* Freek Pols / freekpols / Delft University of Technology
* Faith Uniter Nyakerario/ @afterthesegfault / NAILUG / Nairobi, Kenya

### Ice breaker 🧊⛏️
What was your first programming language or first “technical obsession”?

* Min: TI-82 (calculator) BASIC
* Kirstie: I learned a sed one liner (https://www.unixguide.net/unix/sedoneliner.shtml) at a summer school at the end of my first year of my PhD and it (combined with a bash for loop) transformed my LIFE!
* Ryan: BASIC on a Commodore, PET I think
* April: COBOL (for work) and PASCAL for school I think? 
* HMC: GW-Basic and first technical obsession was writing terminate-and-stay-resident (TSR) programs in Pascal
* Jen: VBA Excel lol
* Stéfan: discovered a Turbo Pascal manual and typed in all the graphics examples
* Angus: PHP 🥹 Just wanted a guest book on my website
* VBS
* First programming language, Golang, Technical obsession the code that made Architectural software like Archicad run.

### Celebrations and shout-outs 🎉

* Simon Li and Paul Hoger for testing JupyterHub 6.0 prereleases
* BIDS is hiring for 4 roles to work on BioJupyter! Please share to your networks!
https://bids.berkeley.edu/news/join-us-were-recruiting-four-positions-build-biojupyter-bids

### Breakout room and agenda item suggestions

* 2nd HubDash: 30 November and 1 December 2026: https://github.com/jupyterhub/team-compass/issues/926
* JupyterHub 6.0 release
  * One last thing (could save for 6.1): https://github.com/jupyterhub/jupyterhub/pull/5500

#### Notes for Main room:
* We are discussing planning for Hub Dash
  * https://github.com/jupyterhub/team-compass/issues/926
* Dates coincide with The Turing Way Book Dash
* Send out a survey before the event and disseminate results at the event
* Last time, there was a call for proposals for what to do at the event
  * e.g. a list of suggested topics and participants ranked them in the order they preferred
* Serena will propose a draft timeline of things for us to work on to prepare for the Hub Dash
* Serena has also started a draft of the survey
  * We spent a few minutes individually looking at it and making small edits
  * Then we started looking at it together section by section
  * Todo: privacy policy for GDPR/Data compliance
    * ask respondent if user is happy to share detailed answers attributable to thempublicly/publish answers in aggregate
  * General tip: give multiple-choice answers with an Other option to make analysis easier
  * Ryan: are there any questions from the Organizational Mycology report that could be relevant to ask to a broader audience in this survey?
...
* Serena Bonaretti / @sbonaretti / Switzerland
* Jérôme Lecoq / jeromelecoq / Allen Institute / Seattle, WA
...
* Kelly Rowland / @kellyrowland / NERSC / Oakland, CA
* Faith Uniter / @afterthesegfault / NAILUG / Nairobi, Kenya
* April Johnson / @aprilmj / 2i2c / Richmond, VA

### Ice breaker 🧊⛏️
What is the last thing you learned unexpectedly?

* Kelly - I learned that in older nautical times they said "larboard" and "starboard" for left and right on the ship, respectively. Larboard was changed to "port" at some point because it is difficult to hear the difference in, e.g., a squall.
* To connect large Ikea cabinets
* To wash the car in Switzerland!
* How thunderstorms have warm air that shoots upward up to 60 mph surrounded by colder air. I knew warm raises, but I didn't know it would go so fast
* The secret backstory of how a locally iconic bar was saved 
* We have an entire paper in the making on unexpected responses in the brain. Look it up: https://allenneuraldynamics.github.io/openscope_p3_data_release_paper/
* The psychology behind the mean nicknames we give our loved ones. 

### Celebrations and shout-outs 🎉
* We've got a new release notes visualizer for Jupyter Book using the listing plugin https://jupyterbook.org/releases/mystmd/
* I discovered that manywidgets is a thing the DevSeed folks have developed out and have a bunch of crazy functionality
  * https://developmentseed.org/manywidgets
  * They even made a full-screen application widget 😅 https://developmentseed.org/manywidgets-playground/situation-room/?fullscreen=situation-room
* Jenny Wong isn't here so I'll hype https://github.com/2i2c-org/jupyterhub-usage-quotas for her 
* BIDS is hiring 6 roles!
  * 4 to work on BioJupyter
  * 2 to work on Lightcone
  * 🧬 Built on the open architecture and ethos of Project Jupyter, BioJupyter will be a modular, open platform for biomedical discovery — one that makes fluid, reproducible collaboration across institutions a natural part of the research environment, with shared data, integrated AI, and full respect for data privacy and security policies. Read more at https://bids.berkeley.edu/news/announcing-biojupyter-advancing-biomedical-research-open-platforms
  * 🌌 Lightcone Research is an international initiative building infrastructure for rigorous AI-assisted computational science. Their open source tools and schemas create a standardized research substrate that captures the scientific decisions, evidence, and provenance behind a result, giving each analysis a structured, inspectable record that establishes soundness and mechanically verifies provenance. Read more at https://www.lightconeresearch.org/
  * The BioJupyter roles are all Open Source Research Software Engineers with distinct focus areas:
    * 🕸️ OSRSE - Computational Infrastructure — deployment and scaling of the Jupyter stack, from laptops to HPC to the cloud https://tinyurl.com/biojupyter-osrse-compinfra
    * 🖥️ OSRSE - User Interfaces — understanding and enhancing the user experience, including Jupyter Lab and other client-side interfaces https://tinyurl.com/biojupyter-osrse-interfaces
    * 🤖 OSRSE - Agentic AI — how AI workflows can support scientific innovation without displacing the researcher https://tinyurl.com/biojupyter-osrse-agenticai
    * 🔬 OSRSE - Product — our spin on a scientific product manager: the bridge between what biomedical researchers need and what we build https://tinyurl.com/biojupyter-osrse-product
  * We've written up an overview blog post, please share widely! https://bids.berkeley.edu/news/join-us-were-recruiting-four-positions-build-biojupyter-bids
    * These roles will all have a first review date of 7 September 2026.
  * The Lightcone Research roles are all Members of Technical Staff (MTS):
    * 🖥️ MTS - Research Software Engineer — designing and implementing the ASTRA specification and integrating their agentic stack for scientific research with high-performance computing facilities https://tinyurl.com/lightcone-mts-rse
    * 🎨 MTS - Product Engineer — engaging directly with scientists to understand their needs, gather feedback, iterate quickly on prototypes, and build solutions within the technical stack https://tinyurl.com/lightcone-mts-product
   * These roles will both have a first review date of 1 September 2026.
  * Please promote these roles to folks in your network! We would love to hear from you or your colleagues / friends! Don't be shy about applying even if you don't seem to tick every single box. Conversely, if you're interested in multiple positions please apply to each of them separately. (Remember to adapt your cover letter to meet the specific prompt for each role.)
  * Two posts on LinkedIn:
    * 🧬 BioJupyter https://www.linkedin.com/posts/biojupyter-osrse-computationalinfrastructure-share-7493750337330294784-d-XQ
    * 🌌 Lightcone https://www.linkedin.com/posts/opensource-hiring-aiforscience-share-7495270570733752320-qScs


### Breakout room and agenda item suggestions
* Serena: JupyterHub: Proposal for the 2nd HubDash: Creating a collection of use cases of JupyterHub deployments (https://github.com/jupyterhub/team-compass/issues/926)
* Demo from Jerome: DeMystify


#### Notes for Main room:
* DeMystify collaborative writing demo
* Synergistic with Freek & team's work: https://gitlab.tudelft.nl/jboss/jesstest/
  * Also found out able https://github.com/antmicro/myst-editor
* Could be contributed to https://contrib.mystmd.org/
...
Name (and pronouns if you'd like) / GitHub handle / affiliation / geographic location
* Kirstie Whitaker (she/her) / @KirstieJane / UC Berkeley / Berkeley, CA (currently at Lawrence Berkeley National Lab looking out over campus and the bay!)
* Faith Uniter Nyakerario/@afterthesegfault/ NAILUG/ Nairobi,Kenya
* Arielle Bennett / @Arielle-Bennett / The Alan Turing Institute  / Boston, MA 
* Min RK / @minrk / UC Berkeley / California
* Silas Santini / @pancakereport / UC Berkeley
* Serena Bonaretti / @sbonaretti / Switzerland
* Kelly Rowland / @kellyrowland / NERSC / SF Bay Area
* Harold Campbell/ @haroldcampbell / 2i2c/ Jamaica
* Yijun Ge /@yijunge-ucb / UC Berkeley
* Brigitta Sipőcz / @bsipocz / Caltecht

### Ice breaker 🧊⛏️
What project (technical or non-technical) are you currently excited about?
* Kirstie: Lightcone Research: https://lightconeresearch.org
  * A new open source project here at BIDS (and at CNRS in Paris, France) working to ensure agentic workflows are auditable and trustworthy
  * We ran their Developer Summit at BIDS's AI Futures Lab last week and it went SO WELL!
    * Loved meeting Deb from NERSC and talking with her at LENGTH about JupyterHub!
* Faith:Building butterboxes and interacting with raspberry Pis also my talk was accepted at ATO
* Min: Running ethernet under my house to improve signal in my home office, which is currently far from my router. We'll see what the rats and frogs think about it. I am also doing this, but by "doing it" I'm asking someone else to because my walls are solid af
* Silas: working my way up to longer and longer open water swims
* Re-launching an opensource project I started years ago
* Kelly: started reading Moby Dick, big classic lit summer
* Arielle: working on my most detailed paint-by-numbers yet (it's a repro of a scientific illustration!): https://canvasbynumbers.com/products/actinae-ernst-haeckel-paint-by-numbers-kit
  * Sick
* Angus: I'm upgrading my home network on top of OpenWRT
 
### Celebrations and shout-outs 🎉
* Serena for engaging with / proposing JHub/JBook meeting changes!

### Breakout room and agenda item suggestions
* JupyterHub: Reviewing Faith's contribution: The PR seeks to update the contributor docs by adding the onboarding section to the guide. https://github.com/jupyterhub/team-compass/pull/916/. It resolves the issue #851 (https://github.com/jupyterhub/team-compass/issues/851) 
* Jupyter Book (general)

#### Notes for Main room: JupyterHub Contributing Guidelines
* Reviewing PR: [[MRG] Updating the guide.mdby adding the Contributor Onboarding guide to it.](https://github.com/jupyterhub/team-compass/pull/916)
  * Working from this draft doc: https://hackmd.io/AvEYKb7iTRGJoofPB8BwqQ?both
* Useful resource: https://docs.google.com/presentation/d/15hZglHXuqUeF5oM_4NnyKTdkciMYblZTzYnAX7XPY4U/edit?slide=id.p#slide=id.p
